...
#WHY DOE?!  (named vs type inference vs positional?) 
Get-Help Get-Process -Parameter name
Get-Help Get-Process -Parameter computername
(Get-Help Get-Process -Parameter name).Position
(Get-Help Get-Process -Parameter computername).Position
###########################################
# 1.2.6
###########################################
1 + 1 * 10
...
###########################################
# whoa there, maybe dedicate a # to filter syntax?
# 2.2
###########################################
Get-Process -Name 'powershell'
...
#New-Item -Path HKCU:\Software\Microsoft\Windows\CurrentVersion\Run #-ItemType directory
...
#Other cool stuff to fit in elsewhere

#Write-Debug ("Status: {0}" status "url: " , url:{1}" -f )
#powershell.exe -ExecutionPolicy Bypass -NoLogo -NonInteractive -NoProfile FOO.ps1
...
get-WmiObject -Class Win32_Service -Property StartMode -Filter "Name='winrm'"
